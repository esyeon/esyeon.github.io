...
function progressList() {
    var table = $("#progressList,#progressList02,#progressList03,#progressList04,#progressList05,#progressList06,#progressList07");
    ...
    stateFields.each(function(i, v) {
        ...
        var prop = {
            ...
            //type: current.is(":last-child") &&  "http://10.10.35.213/markup/hyundai"+ "/html" || "../html",
			type: current.is(":last-child") &&  "../"+ "/html" || "../html",
        ...
        }else if (current.text() == "1차 완료") {
            current.addClass("one-complete");
        }
